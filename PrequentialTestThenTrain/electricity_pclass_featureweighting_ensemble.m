%clear
clc
%load('D:\NTU Research\Codes\NewDSSCNdata\electricitypricing\electprice.mat')
...
alpha=0.001; %confidence drift
%alpha=1;
ninput=8;
noutput=2;
decreasingfactor=0.5; 
threshold=0.001;    %threshold merging
confidenceinterval=0.001;    %confidence drift
model=1;
p1=1.5;
p2=1.5; %
